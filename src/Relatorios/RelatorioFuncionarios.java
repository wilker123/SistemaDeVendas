...
public class RelatorioFuncionarios implements ActionListener{
private JTextField relatorio;
	
	public RelatorioFuncionarios(JTextField relatorio) {
	...
	private void gererRelatorio() {
		...
		String jasper = "C:\\Users\\Thiago\\JaspersoftWorkspace\\RelatórioFuncionário\\funcionario.jasper";
		
		HashMap<String, Object> param = new HashMap<String, Object>();
		param.put("funcionario", acesso);
